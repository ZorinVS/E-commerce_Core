...
if __name__ == "__main__":
    ...
    # ==================== Доп. задание =====================================================
    print("\n" + "*")
    print("Товар в наличии: ", product1.quantity, "штук\n")

    # успешное добавление
    print("Заказ товара в количестве 2 шт:")
    order1 = Order(product1, 2)
    print()

    # нет возможности сделать заказ с нулевым количеством товара
    print("Заказ товара в количестве 0 шт:")
    order2 = Order(product1, 0)
    print()

    # товара нет в нужном количестве на складе
    print("Заказ товара в количестве 4 шт:")
    order3 = Order(product1, 4)
